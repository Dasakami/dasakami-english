...
(function (window){
  ...
  //========================
      ...
      function startDemo(){
          ...
          var logoText = "FLAPPY WORD";
          if(!logoCanvas){
              logoCanvas = document.createElement("canvas");
              logoCanvasBG = document.createElement("canvas");
          }
          createLogo("FLAPPY WORD", logoCanvas, logoCanvasBG);
          if(!gameOverCanvas){
      ...
      function createLogo(logoText, logoCanvas, logoCanvassBG){
          ...
          logoBGContext.fillStyle = "#E27BB1";
          ...
          logoContext.strokeStyle = "#964B00";
  ...
  function createCityGraphic(){
      ...
      cgContext.fillStyle = "#FFFFFF";
      cgContext.strokeStyle = "#964B00";
